...
export const LAST_DB_KEY = 'sampleApp.lastDbBase64';
export const LAST_DB_NAME_KEY = 'sampleApp.lastDbName';

export const LAST_SYNC_VERSION_KEY = 'LIMS_LAST_SYNC_VERSION';

export const MASTER_DB_FILENAME = 'sample_db_Master.sqlite';
